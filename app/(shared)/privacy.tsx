...
export default function PrivacyPolicyScreen() {
  const privacyContent = [
    ...
    },
    {
      ...
      content:
        "We do not sell your personal information. We may share your information with NGOs and volunteers only as necessary to provide our services.",
    },
    {
      title: "Data Security",
      content:
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.introduction}>
          At Khaana Khazana, we take your privacy seriously. This Privacy Policy
        ...
        <View style={styles.contactSection}>
          ...
          <Text style={styles.contactInfo}>privacy@ShareBite .com</Text>
        </View>
      </View>
    </ScrollView>
  );
